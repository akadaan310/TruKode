...
const REVEALS = [
  ["How you connect", "The natural chemistry between your two blueprints — where you flow together."],
  ["How you communicate", "The way each of you tends to give, receive, and interpret meaning."],
  ["Where you clash", "The friction points that tend to surface, and what sits beneath them."],
  ["Complementary strengths", "What each of you brings that the other may be missing."],
  ["Growth as a pair", "The tendencies you can lean into to grow closer over time."],
];

const INSIDE = [
  ["01", "Both Personal Data", "The details each blueprint is built from."],
  ["02", "Your Core Numbers", "The foundational numbers that anchor both of you."],
  ["03", "Your Connection Profile", "A cohesive portrait of how your blueprints meet."],
  ["04", "Communication Patterns", "How each of you tends to speak — and be heard."],
  ["05", "Friction & Repair", "The recurring clashes, and the way back to each other."],
  ["06", "Your Guidance", "Gentle direction for growing together over time."],
];

const WHO = [
  ["01", "The New Couple", "Early in something real, and curious how deep the fit really runs."],
  ["02", "The Long-Committed", "Years in, and ready to understand each other more truly."],
  ["03", "At a Turning Point", "Weighing a bigger step, wanting clarity before you take it."],
  ["04", "The Close Pair", "Partners, friends, or family who want to decode a bond that matters."],
];

export default function CompatibilityReadPage() {
  return (
    <div className="bg-ink">
      ...
      <section id="top" className="relative overflow-hidden bg-ink">
        ...
        <div className="relative mx-auto max-w-[1160px] px-[clamp(22px,5vw,56px)] pb-[clamp(72px,11vh,120px)] pt-[clamp(40px,6vh,64px)]">
          <Reveal className="mb-[clamp(40px,7vh,72px)] flex items-center gap-[9px] font-sans text-[13px] text-light-soft">
            ...
            <span className="text-gold">Compatibility Read™</span>
          </Reveal>
          ...
          <div className="flex flex-wrap items-center gap-[clamp(36px,6vw,72px)]">
            <div className="flex-[1_1_360px] min-w-[min(100%,360px)]">
              ...
              >
                How you and your partner connect, communicate, and clash — and
                where the two of you truly meet.
              </Reveal>
      ...
      <section className="bg-cream">
        <div className="mx-auto max-w-[1000px] px-[clamp(22px,5vw,56px)] py-[clamp(80px,13vh,150px)]">
          <div className="max-w-[640px]">
            ...
            >
              A clear portrait of how two blueprints meet.
            </Reveal>
            <Reveal
              as="p"
              delay={0.14}
            ...
            >
              Drawn from both of your own data — framed as tendencies and
              possibilities to explore together, never fixed verdicts.
            </Reveal>
          </div>
      ...
      <section id="inside" className="bg-ink">
        <div className="mx-auto max-w-[920px] px-[clamp(22px,5vw,56px)] py-[clamp(80px,13vh,150px)]">
          <div className="mx-auto max-w-[620px] text-center">
            ...
            >
              Six considered sections, building from both your blueprints to the
              shape of your connection.
            </Reveal>
          </div>
      ...
      <section className="bg-cream">
        <div className="mx-auto max-w-[1080px] px-[clamp(22px,5vw,56px)] py-[clamp(80px,13vh,150px)]">
          <div className="mx-auto max-w-[640px] text-center">
            ...
            >
              For any bond worth understanding.
            </Reveal>
            <Reveal
              as="p"
              delay={0.14}
            ...
            >
              If you recognize your relationship in any of these, the
              Compatibility Read is for you.
            </Reveal>
          </div>
          ...
          >
            <div className="p-[clamp(30px,5vw,52px)]">
              <div className="font-sans text-[10px] uppercase tracking-[0.18em] text-gold">
                Excerpt · Your Connection Profile
              </div>
              ...
              <p className="mt-[18px] max-w-[620px] text-[clamp(15px,2vw,17px)] leading-[1.75] text-light-soft">
                Your two blueprints may share a quiet gravitational pull — one of
                you leading with warmth, the other with steadiness, each drawn to
                what the other makes look effortless. The connection tends to
                deepen fastest when you both slow down enough to be understood.
              </p>
              <p className="mt-[14px] max-w-[620px] select-none text-[clamp(15px,2vw,17px)] leading-[1.75] text-light-soft opacity-60 blur-[5px]">
                Friction is likely to surface around pace and reassurance: one of
                you may need to talk a thing through in the moment, while the other
                withdraws to process alone — a mismatch that reads as distance
                when it&apos;s often just different timing.
              </p>
              <p className="mt-[14px] max-w-[620px] select-none text-[clamp(15px,2vw,17px)] leading-[1.75] text-light-soft opacity-45 blur-[6px]">
                Across your patterns, a recurring theme of complementary
                strengths emerges — where one of you tends to open, the other
                tends to hold, and the relationship steadies when both are named.
              </p>
            </div>
            <div className="absolute bottom-0 left-0 right-0 flex h-[62%] flex-col items-center justify-end gap-[14px] bg-[linear-gradient(transparent,var(--ink-soft)_72%)] pb-[34px]">
              ...
              >
                Get your Compatibility Read — $59–79
              </Link>
            </div>
          </Reveal>
        </div>
      ...
      <section className="bg-cream">
        <div className="mx-auto max-w-[840px] px-[clamp(22px,5vw,56px)] py-[clamp(72px,11vh,130px)] text-center">
          ...
          >
            This isn&apos;t couples therapy, a diagnosis, or a compatibility quiz.
            It&apos;s a{" "}
            <span className="text-gold-strong">shared foundation</span> — built
            from both your data, written in possibilities to explore rather than
            verdicts on your bond.
          </Reveal>
        </div>
      </section>
          ...
          >
            <div className="flex-[1_1_280px]">
              ...
              <p className="mt-[12px] max-w-[420px] text-[15.5px] leading-[1.6] text-dark-soft">
                Knowing your own blueprint first makes every connection clearer.
                Understand who you are at your core before you decode who you are
                together.
              </p>
            </div>
      ...
      <section id="get" className="relative overflow-hidden bg-ink">
        ...
        <div className="relative mx-auto max-w-[820px] px-[clamp(22px,5vw,56px)] py-[clamp(90px,15vh,170px)] text-center">
          ...
          >
            Two blueprints, one clear picture.
          </Reveal>
          <Reveal
            delay={0.22}
