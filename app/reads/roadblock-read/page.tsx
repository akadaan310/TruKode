...
const REVEALS = [
  ["Your recurring blocks", "The specific patterns that keep showing up when you try to move."],
  ["The root beneath them", "What your blueprint suggests is actually driving the stall."],
  ["Your self-sabotage style", "The quiet ways you tend to get in your own way."],
  ["The fears underneath", "The protective instincts that once helped and now hold."],
  ["The path through", "The tendencies you can lean on to move forward again."],
];
...
const INSIDE = [
  ...
  ["03", "Your Block Profile", "A cohesive portrait of what tends to stop you."],
  ["04", "Root Patterns", "The deeper drivers beneath the surface stall."],
  ["05", "Your Way Through", "Gentle, practical direction for moving again."],
  ["06", "Your North Star", "The orienting principle to return to."],
];

const WHO = [
  ["01", "The Stuck", "Trying hard, but somehow circling the same spot for a while now."],
  ["02", "The Pattern-Noticer", "You keep landing in the same place and want to know why."],
  ["03", "On the Edge of Change", "Ready to move, and wanting to clear what's in the way first."],
  ["04", "The Self-Aware", "You know something's holding you back — you just can't name it."],
];

export default function RoadblockReadPage() {
  return (
    <div className="bg-ink">
      ...
      <section id="top" className="relative overflow-hidden bg-ink">
        ...
        <div className="relative mx-auto max-w-[1160px] px-[clamp(22px,5vw,56px)] pb-[clamp(72px,11vh,120px)] pt-[clamp(40px,6vh,64px)]">
          <Reveal className="mb-[clamp(40px,7vh,72px)] flex items-center gap-[9px] font-sans text-[13px] text-light-soft">
            ...
            <span className="text-gold">Roadblock Read™</span>
          </Reveal>
          ...
          <div className="flex flex-wrap items-center gap-[clamp(36px,6vw,72px)]">
            <div className="flex-[1_1_360px] min-w-[min(100%,360px)]">
              ...
              >
                The specific patterns blocking you from moving forward — named, so
                they can finally move.
              </Reveal>
      ...
      <section className="bg-cream">
        <div className="mx-auto max-w-[1000px] px-[clamp(22px,5vw,56px)] py-[clamp(80px,13vh,150px)]">
          <div className="max-w-[640px]">
            ...
            >
              A clear look at what&apos;s been standing in your way.
            </Reveal>
            <Reveal
              as="p"
              delay={0.14}
            ...
            >
              Drawn from your own data — framed as patterns to work with, never
              flaws to fix or verdicts to carry.
            </Reveal>
          </div>
      ...
      <section id="inside" className="bg-ink">
        <div className="mx-auto max-w-[920px] px-[clamp(22px,5vw,56px)] py-[clamp(80px,13vh,150px)]">
          <div className="mx-auto max-w-[620px] text-center">
            ...
            >
              Six considered sections, moving from your raw data to a clear way
              through.
            </Reveal>
          </div>
      ...
      <section className="bg-cream">
        <div className="mx-auto max-w-[1080px] px-[clamp(22px,5vw,56px)] py-[clamp(80px,13vh,150px)]">
          <div className="mx-auto max-w-[640px] text-center">
            ...
            >
              For anyone ready to move again.
            </Reveal>
            <Reveal
              as="p"
              delay={0.14}
            ...
            >
              If you recognize yourself in any of these, the Roadblock Read is
              your way through.
            </Reveal>
          </div>
          ...
          >
            <div className="p-[clamp(30px,5vw,52px)]">
              <div className="font-sans text-[10px] uppercase tracking-[0.18em] text-gold">
                Excerpt · Your Block Profile
              </div>
              <h3 className="mt-[14px] font-serif text-[clamp(24px,3.6vw,32px)] font-medium leading-[1.15] text-light">
                What tends to stop you
              </h3>
              <p className="mt-[18px] max-w-[620px] text-[clamp(15px,2vw,17px)] leading-[1.75] text-light-soft">
                The block your blueprint keeps circling may not be a lack of
                effort — it may be a need to feel fully ready before you begin.
                That instinct once kept you safe from failing publicly; now it
                tends to delay the very starts that would move you forward.
              </p>
              <p className="mt-[14px] max-w-[620px] select-none text-[clamp(15px,2vw,17px)] leading-[1.75] text-light-soft opacity-60 blur-[5px]">
                Beneath it sits a quieter pattern of over-responsibility — a
                tendency to carry more than is yours, until the weight itself
                becomes the reason nothing moves. The stall isn&apos;t laziness;
                it&apos;s an overloaded system protecting itself.
              </p>
              <p className="mt-[14px] max-w-[620px] select-none text-[clamp(15px,2vw,17px)] leading-[1.75] text-light-soft opacity-45 blur-[6px]">
                The way through appears to begin small: one honest boundary, one
                unfinished start allowed to stay unfinished, and the pattern
      ...
      <section className="bg-cream">
        <div className="mx-auto max-w-[840px] px-[clamp(22px,5vw,56px)] py-[clamp(72px,11vh,130px)] text-center">
          ...
          >
            This isn&apos;t therapy, a diagnosis, or a list of what&apos;s wrong
            with you. It&apos;s a{" "}
            <span className="text-gold-strong">clear look at your patterns</span>{" "}
            — drawn from your own data, written as things to work with rather than
            faults to carry.
          </Reveal>
        </div>
      </section>
          ...
          >
            <div className="flex-[1_1_280px]">
              ...
              <p className="mt-[12px] max-w-[420px] text-[15.5px] leading-[1.6] text-dark-soft">
                With the roadblocks named, find where all that freed-up energy is
                meant to go — your soul direction and the mission beneath your
                days.
              </p>
            </div>
      ...
      <section id="get" className="relative overflow-hidden bg-ink">
        ...
        <div className="relative mx-auto max-w-[820px] px-[clamp(22px,5vw,56px)] py-[clamp(90px,15vh,170px)] text-center">
          ...
          >
            What&apos;s named can finally shift.
          </Reveal>
          <Reveal
            delay={0.22}
