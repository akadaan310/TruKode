...
const REVEALS = [
  ["Your professional strengths", "The capacities you bring most naturally to your work."],
  ["Your natural direction", "The kind of work your blueprint tends to pull you toward."],
  ["Your working style", "How you're inclined to lead, build, decide, and collaborate."],
  ["Your professional blocks", "The tendencies that can quietly cap your momentum."],
  ["Your ideal environment", "The conditions in which you're most likely to do your best work."],
];
...
const INSIDE = [
  ...
  ["03", "Your Professional Profile", "A cohesive portrait of how you work best."],
  ["04", "Strengths & Direction", "The work you're built for, and where to aim it."],
  ["05", "Blocks & Growth", "The professional patterns to watch, and how to grow."],
  ["06", "Your North Star", "The orienting principle to return to."],
];

const WHO = [
  ["01", "The Career Changer", "Considering a new direction, wanting it to fit who you really are."],
  ["02", "The Builder", "Starting or growing something, and wanting it aligned with your strengths."],
  ["03", "The Achiever", "Successful, but sensing you're not yet playing to your natural edge."],
  ["04", "At a Career Crossroads", "Weighing a next move, ready for clarity before you commit."],
];

export default function CareerBusinessReadPage() {
  return (
    <div className="bg-ink">
      ...
      <section id="top" className="relative overflow-hidden bg-ink">
        ...
        <div className="relative mx-auto max-w-[1160px] px-[clamp(22px,5vw,56px)] pb-[clamp(72px,11vh,120px)] pt-[clamp(40px,6vh,64px)]">
          <Reveal className="mb-[clamp(40px,7vh,72px)] flex items-center gap-[9px] font-sans text-[13px] text-light-soft">
            ...
            <span className="text-gold">Career / Business Read™</span>
          </Reveal>
          ...
          <div className="flex flex-wrap items-center gap-[clamp(36px,6vw,72px)]">
            <div className="flex-[1_1_360px] min-w-[min(100%,360px)]">
              ...
              >
                Your natural professional strengths, direction, and the blocks
                between you and your best work.
              </Reveal>
      ...
      <section className="bg-cream">
        <div className="mx-auto max-w-[1000px] px-[clamp(22px,5vw,56px)] py-[clamp(80px,13vh,150px)]">
          <div className="max-w-[640px]">
            ...
            >
              A clear picture of the work you&apos;re built for.
            </Reveal>
            <Reveal
              as="p"
              delay={0.14}
            ...
            >
              Drawn from your own data — framed as strengths and directions to
              explore, never a job title to obey.
            </Reveal>
          </div>
      ...
      <section id="inside" className="bg-ink">
        <div className="mx-auto max-w-[920px] px-[clamp(22px,5vw,56px)] py-[clamp(80px,13vh,150px)]">
          <div className="mx-auto max-w-[620px] text-center">
            ...
            >
              Six considered sections, building from your raw data to a clear
      ...
      <section className="bg-cream">
        <div className="mx-auto max-w-[1080px] px-[clamp(22px,5vw,56px)] py-[clamp(80px,13vh,150px)]">
          <div className="mx-auto max-w-[640px] text-center">
            ...
            >
              For anyone building a working life that fits.
            </Reveal>
            <Reveal
              as="p"
              delay={0.14}
            ...
            >
              If you recognize yourself in any of these, the Career / Business
              Read is your edge.
            </Reveal>
          </div>
          ...
          >
            <div className="p-[clamp(30px,5vw,52px)]">
              <div className="font-sans text-[10px] uppercase tracking-[0.18em] text-gold">
                Excerpt · Your Professional Profile
              </div>
              ...
              <p className="mt-[18px] max-w-[620px] text-[clamp(15px,2vw,17px)] leading-[1.75] text-light-soft">
                Your blueprint may do its best work at the edge between vision and
                execution — able to see the larger shape of a thing and still care
                about whether the details hold. You tend to lead by earning trust
                rather than demanding it, and to build things meant to last.
              </p>
              <p className="mt-[14px] max-w-[620px] select-none text-[clamp(15px,2vw,17px)] leading-[1.75] text-light-soft opacity-60 blur-[5px]">
                Your professional block appears to live in delegation: a quiet
                belief that it&apos;s faster to do it yourself can cap the very
                growth you&apos;re working toward. The strength that makes you
                dependable is the same one that can keep you a bottleneck.
              </p>
              <p className="mt-[14px] max-w-[620px] select-none text-[clamp(15px,2vw,17px)] leading-[1.75] text-light-soft opacity-45 blur-[6px]">
                Your ideal environment seems to reward autonomy over supervision,
                and meaning over pure metrics — where you&apos;re trusted with the
                outcome and left to find the path.
              </p>
            </div>
            <div className="absolute bottom-0 left-0 right-0 flex h-[62%] flex-col items-center justify-end gap-[14px] bg-[linear-gradient(transparent,var(--ink-soft)_72%)] pb-[34px]">
              ...
              >
                Get your Career / Business Read — $49
              </Link>
            </div>
          </Reveal>
        </div>
      ...
      <section className="bg-cream">
        <div className="mx-auto max-w-[840px] px-[clamp(22px,5vw,56px)] py-[clamp(72px,11vh,130px)] text-center">
          ...
          >
            This isn&apos;t a career test, a diagnosis, or a prescription for what
            job to take. It&apos;s a{" "}
            <span className="text-gold-strong">professional foundation</span> —
            drawn from your own data, written in strengths to build on rather than
            a role to squeeze into.
          </Reveal>
        </div>
      </section>
          ...
          >
            <div className="flex-[1_1_280px]">
              ...
              <p className="mt-[12px] max-w-[420px] text-[15.5px] leading-[1.6] text-dark-soft">
                Your work is one expression of a larger direction. See where it
                all points — your soul direction and the mission beneath your
                days.
              </p>
            </div>
      ...
      <section id="get" className="relative overflow-hidden bg-ink">
        ...
        <div className="relative mx-auto max-w-[820px] px-[clamp(22px,5vw,56px)] py-[clamp(90px,15vh,170px)] text-center">
          ...
          >
            Build on what you&apos;re built for.
          </Reveal>
          <Reveal
            as="p"
            delay={0.16}
